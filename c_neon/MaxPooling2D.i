# 1 "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c" 2
...
# 3 "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c" 2
...
typedef short FP16;
# 4 "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c" 2
...
# 5 "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c" 2
...
int CQT_MaxPooling2D_if_of (CQT_LAYER *lp, void *inp, void *outp)
{
    ...
    ((mpp->pool_size[0]==2) ? (void) (0) : __assert_fail ("mpp->pool_size[0]==2", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 15, __PRETTY_FUNCTION__));
    ((mpp->pool_size[1]==2) ? (void) (0) : __assert_fail ("mpp->pool_size[1]==2", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 16, __PRETTY_FUNCTION__));

    int input_size_x = lp->cqt_input_shape[1];
    int input_size_y = lp->cqt_input_shape[2];
    int input_size_num = lp->cqt_input_shape[3];
    int output_size_x = lp->cqt_output_shape[1];
    int output_size_y = lp->cqt_output_shape[2];
    ...
    _Bool stride_1_padding_same_mode = 0;

    input_padding = lp->neon_padding_hi;
    input_data_size_x = (4) + input_size_x + input_padding;
    input_data_size_y = input_size_y + (2) * 3;

    output_padding = lp->neon_padding_ho;
    output_data_size_x = (4) + output_size_x + output_padding;
    output_data_size_y = output_size_y + (2) * 3;




    if((mpp->strides[0]==1) && (mpp->strides[1]==1) && (mpp->padding==PD_SAME)) {
        ((mpp->pool_size[0]==2) ? (void) (0) : __assert_fail ("mpp->pool_size[0]==2", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 51, __PRETTY_FUNCTION__));
        ((mpp->pool_size[1]==2) ? (void) (0) : __assert_fail ("mpp->pool_size[1]==2", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 52, __PRETTY_FUNCTION__));
        stride_1_padding_same_mode = 1;
    } else {
        ((mpp->strides[0]==2) ? (void) (0) : __assert_fail ("mpp->strides[0]==2", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 55, __PRETTY_FUNCTION__));
        ((mpp->strides[1]==2) ? (void) (0) : __assert_fail ("mpp->strides[1]==2", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 56, __PRETTY_FUNCTION__));

        if(mpp->padding!=PD_VALID) {


            ((mpp->padding==PD_SAME) ? (void) (0) : __assert_fail ("mpp->padding==PD_SAME", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 61, __PRETTY_FUNCTION__));
            ((input_size_x%2==0) ? (void) (0) : __assert_fail ("input_size_x%2==0", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 62, __PRETTY_FUNCTION__));
            ((input_size_y%2==0) ? (void) (0) : __assert_fail ("input_size_y%2==0", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 63, __PRETTY_FUNCTION__));
        }
    }


    if(stride_1_padding_same_mode == 0) {
            ...
            for(y=0;y<input_size_y;y+=2) {
                for(x=0;x<input_size_x;x+=2){
                    idx_i = n * (input_data_size_y * input_data_size_x)
                            + ((y + (2)) * input_data_size_x)
                            + (x + (4));

                    idx_o = n * (output_data_size_y * output_data_size_x)
                            + (((y/2) + (2)) * output_data_size_x)
                            + ((x/2) + (4)) ;
        ...
        ((stride_1_padding_same_mode) ? (void) (0) : __assert_fail ("stride_1_padding_same_mode", "/home/pi/dl_ans/c_neon/cqt_lib/MaxPooling2D.c", 104, __PRETTY_FUNCTION__));
        for(n=0;n<input_size_num;n++) {
