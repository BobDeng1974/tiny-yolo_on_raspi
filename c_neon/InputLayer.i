# 1 "/home/pi/dl_ans/c_neon/cqt_lib/InputLayer.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "/home/pi/dl_ans/c_neon/cqt_lib/InputLayer.c" 2
...
# 3 "/home/pi/dl_ans/c_neon/cqt_lib/InputLayer.c" 2
...
typedef short FP16;
# 5 "/home/pi/dl_ans/c_neon/cqt_lib/InputLayer.c" 2
...
# 6 "/home/pi/dl_ans/c_neon/cqt_lib/InputLayer.c" 2
...
int CQT_InputLayer_if_of (CQT_LAYER *np, void *inp, void *outp)
{
    ...
    output_size_x = (4) + input_size_x + (0);
    output_size_y = input_size_y + (2) * 3;

    ip = (float *)inp;
    op = (float *)outp;


    ((input_size_x % 4 == 0) ? (void) (0) : __assert_fail ("input_size_x % 4 == 0", "/home/pi/dl_ans/c_neon/cqt_lib/InputLayer.c", 36, __PRETTY_FUNCTION__));
    ...
    for(f=0;f<fill_num;f++) {
        for(y=0;y<input_size_y;y++) {
            for(x=0;x<input_size_x;x++) {
                ...
                idx_o = f * output_size_y * output_size_x + (y + (2)) * output_size_x + (x + (4));
                data = *(ip + idx_i);
                *(op + idx_o) = data;
            }
        }
